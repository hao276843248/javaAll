...
<body>
	...
	<div class="main">
		...
		<div id="right">
			...
			<div class="position">
				<span>您的位置：<a href="index.jsp">首页&nbsp;></a>成功案例</span>成功案例
			</div>
			<div class="web_box">
				<div class="content">
					<div class="c-top">
					...
					<!--c-top end-->
					<div class="clear"></div>
					<div class="contents">${c.content}</div>
					<!--content end-->
					<div class="pagenav">
						<dl>
							...
							<c:if test="${preContent!=null}">
								<dd class="s">
									<strong>上一篇：</strong><a
										href="case_detail.jsp?id=${preContent.id}">${preContent.title}</a>
								</dd>
							</c:if>
							...
							<c:if test="${nextContent!=null}">
								<dd class="x">
									<strong>下一篇：</strong><a
										href="case_detail.jsp?id=${nextContent.id}">${nextContent.title}</a>
								</dd>
							</c:if>
						</dl>
					</div>
