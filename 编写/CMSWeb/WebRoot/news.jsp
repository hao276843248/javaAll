...
<body>
	...
	<div class="main">
		...
		<div id="right">
			...
			<div class="position">
				<span>您的位置：<a href="index.jsp">首页&nbsp;></a>${cs[0].cname}</span>新闻资讯
			</div>
			<div class="web_box">
				<div class="content">
					...
					<ul class="news">
						<c:forEach items="${cs}" var="c">
							<li><a href="new_detail.jsp?id=${c.id}"><span><fmt:formatDate value="${c.addtime}" pattern="yyyy-MM-dd" /> </span>${c.title}</a></li>
						</c:forEach>
					</ul>
					<!-- pageMain -->
