...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
        ...
        <h3>发表评论:-----><a href="wangzhanmethod!contentupdate3.action?id=${content.id }">${content.title }</a></h3>
              <hr />  
              
                    
                    
                    
           <form action="wangzhanmethod!pinglun2.action?contentid=${content.id }"  method="post" >
<TABLE class=sel_table border=1 cellSpacing=0 cellPadding=0 width="100%">
  <THEAD>
  <TR >
    <TH width="30%" align="right">评论内容：</TH>
    <TH width="70%">
    <textarea rows="7" cols="50" name="pingluncontent" ></textarea>
