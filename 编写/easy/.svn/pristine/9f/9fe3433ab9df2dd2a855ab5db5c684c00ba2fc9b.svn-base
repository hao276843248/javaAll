		...
		<c:choose>
			<c:when test="${user!=null}">
				<c:choose>
					...
					<a href="index.html">欢迎--${user.euUserName}--</a><a href="logout.html">注销</a><a href="manage/index.html">进入后台管理</a>
					</c:when>
					<c:otherwise>
					<a href="#" class="shopping">购物车</a><a href="index.html">欢迎--${user.euUserName}--</a><a href="logout.html">注销</a><a href="guestbook.html">留言</a>
					</c:otherwise>
				</c:choose>
			</c:when>
			<c:otherwise>
