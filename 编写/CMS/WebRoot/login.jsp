	...
	<div id="login">
		...
		<table width="100%" border="0">
			<tr class="fitem">
				...
				<td class="finput">
					<input type="text" name="userName" class="txt" value="${param.userName}"/>
				</td>
			</tr>
			<tr class="ferror">
				<td></td>
			...
			<tr class="fitem">
				...
				<td class="finput">
					<input type="text" name="vcode" class="txt"/><br/>
					<img id="imgVcode" src="vcode.jpg" width="150" height="50" onclick="refreshVcode()"/>
				</td>
			</tr>
			<tr class="ferror">
				<td></td>
