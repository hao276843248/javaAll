	...
	<div class="main">
		<div class="price-off">
			...
			<ul class="product clearfix">
				<c:forEach items="${product1.results}" var="product1">
					<li>
						<dl>
							<dt><a href="product-view.html" target="_blank"><img src="images/product/${product1.epFileName}" /></a></dt>
			...
			<div class="news-list">
				<h4>最新留言</h4>
					<c:forEach items="${commentFind.results}" var="commentFind">
						<ul>
							<li><a href="news-view.html" target="_blank">${commentFind.ecContent}</a></li>
						</ul>
					</c:forEach>
			</div>
			<div class="spacer"></div>
		...
		<div class="hot">
			...
			<ul class="product clearfix">
				<c:forEach items="${product2.results}" var="product2">
					<li>
						<dl>
							<dt><a href="product-view.html" target="_blank"><img src="images/product/${product2.epFileName}" /></a></dt>
